...
p1g=s2 %>% ggplot(aes(x=sheep_num,y=fct_inorder(test),fill=result)) +
     ...
     ggtitle("Testing of sheep herds")

p1g
 ggsave(filename=here("figs","data_sheep.png"), width=12,height=8,units="cm"   )    
```
