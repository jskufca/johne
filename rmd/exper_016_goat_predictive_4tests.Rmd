...
We will analyze using 4 tests (Culture, PCR, and 2 Elisa tests).
...
* The data set has been cleaned to remove some incomplete data sets.
...
goat_file_old=here("data","goat_results.xlsx")


#goat = readxl::read_excel(goat_file, sheet = "Sheet1") %>%
goat_old = readxl::read_excel(goat_file_old,sheet="surrogate_data_1") %>%
